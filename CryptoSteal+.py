...
class CryptoStealMod(loader.Module):
    """Автоматически проверяет CryptoBot (и другие провереные боты) на чеки."""
    ...
    strings_ru = {
        ...
        "asset_chat_got_check": (
            "❗️Обнаружен новый чек, надеюсь ты его получил!\n🔗 Ссылка на обнаруженый чек: {u1}?start={u2} или <code>/start {u2}</code> в {u1}"
